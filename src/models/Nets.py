...
class LogisticRegressionCIFAR10(nn.Module):
    def __init__(self):
        super(LogisticRegressionCIFAR10, self).__init__()
...
class VAE(nn.Module):
    def __init__(self,input_dim=784, latent_dim=100,hidden_dim=500):
    ...
    def sample_normal(self,mean,logvar):
        ...
        e = torch.randn(sd.size()).to(mean.device) 
